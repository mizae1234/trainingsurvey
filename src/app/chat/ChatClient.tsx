  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 'welcome',
      sender: 'bot',
      text: `สวัสดีครับคุณ ${currentUser.displayName}! ผม "บัดดี้" (Buddy) บอทแปลภาษาเป็น SQL พร้อมตอบคำถามคุณแล้วครับ\n\nลองถามข้อมูลเกี่ยวกกับแบบประเมินผู้ฝึกหน้าร้านได้เลยครับ (เช่น "ขอคะแนนเฉลี่ยภาพรวมของโครงการ" หรือ "สาขาบางนาได้คะแนนข้อ 5 เท่าไหร่")`,
      timestamp: new Date()
    }
  ]);
