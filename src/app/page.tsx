...
export default function SurveyPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    q1_benefit: 4,
    q2_apply_knowledge: 4,
    q3_consistency: 4,
    q4_1_duration_suitability: 'มีความเหมาะสม',
    q4_2_branches_suitability: 'มีความเหมาะสม',
    
    q5_clarity_branch1: 4,
    q5_clarity_branch2: 4,
    q6_volume_branch1: 4,
    q6_volume_branch2: 4,
    q7_readiness_branch1: 4,
    q7_readiness_branch2: 4,
    
    q8_trainer_knowledge_branch1: 4,
    q8_trainer_knowledge_branch2: 4,
    q9_safety_hygiene_branch1: 4,
    q9_safety_hygiene_branch2: 4,
    q10_trainer_care_branch1: 4,
    q10_trainer_care_branch2: 4,
    q11_atmosphere_branch1: 4,
    q11_atmosphere_branch2: 4,
      ...
      <div className="survey-card">
        ...
        {step === 1 && (
          <div className="survey-instructions">
            <strong>คำชี้แจง:</strong> แบบสอบถามนี้จัดทำขึ้นเพื่อนำข้อมูลไปพัฒนาและปรับปรุงระบบการฝึกอบรมของฝ่ายทรัพยากรบุคคล (HRD) โดยคำตอบของท่านจะถูกเก็บเป็นความลับและประมวลผล ซึ่งไม่มีผลต่อการประเมินผลการปฏิบัติงานใดๆ ทั้งสิ้น
          </div>
        )}
          ...
          <div className="survey-body">
              ...
              <div className="step-content">
                ...
                <div className="question-row">
                  <div className="question-text">
                    1. การฝึกหน้าร้านมีประโยชน์และช่วยให้เข้าใจผลิตภัณฑ์/บริการของบริษัทมากขึ้น
                  </div>
                ...
                <div className="question-row">
                  <div className="question-text">
                    2. สามารถนำความรู้และทักษะที่ได้รับจากหน้าร้าน ไปปรับ/ประยุกต์ใช้กับการทำงานในสายงานที่ปฏิบัติได้
                  </div>
                  <div className="rating-group">
                    {[4, 3, 2, 1].map(num => (
                      <div 
                ...
                <div className="question-row">
                  <div className="question-text">
                    3. แนวทางการปฏิบัติงานและคำแนะนำที่ได้รับจากทั้ง 2 สาขา เป็นไปในทิศทางเดียวกัน
                  </div>
                  <div className="rating-group">
                    {[4, 3, 2, 1].map(num => (
                      <div 
                ...
                <div style={{ marginTop: '32px' }} className="section-header">
                  <div className="section-title">ความเหมาะสมของ "ระยะเวลา 5 วัน กับการเรียนรู้ใน 2 สาขา"</div>
                </div>

                {/* Q4.1 */}
                <div className="form-group">
                  <label className="form-label" style={{ fontWeight: 600 }}>4.1 ระยะเวลาในการฝึกหน้าร้าน</label>
                ...
                <div className="form-group" style={{ marginTop: '20px' }}>
                  <label className="form-label" style={{ fontWeight: 600 }}>4.2 จำนวนสาขาในการฝึกหน้าร้าน</label>
                  <div className="horizontal-choices">
                    {['น้อยเกินไป', 'มีความเหมาะสม', 'มากเกินไป'].map(choice => (
                      <div
                        key={choice}
            ...
            {step === 3 && (
              <div className="step-content">
                ...
                {/* Q5 */}
                <div className="question-row">
                  <div className="question-text">5. การสอนในแต่ละส่วนงาน มีความชัดเจน เป็นลำดับขั้นตอน ไม่สับสน</div>
                ...
                {/* Q6 */}
                <div className="question-row">
                  <div className="question-text">6. ปริมาณเนื้อหาและงานที่ได้รับ มีความเหมาะสมกับเวลาที่กำหนดไว้</div>
                  <div className="branch-comp-grid">
                    <div>
                      <div className="branch-panel-title" style={{ fontSize: '11px', marginBottom: '6px' }}>สาขา 1: {formData.branch1}</div>
                      <div className="rating-group">
                ...
                {/* Q7 */}
                <div className="question-row">
                  <div className="question-text">7. สาขามีการจัดเตรียมอุปกรณ์เครื่องมือ หรือเอกสารประกอบการสอนไว้ให้อย่างพร้อมใช้งาน</div>
                  <div className="branch-comp-grid">
                    <div>
                      <div className="branch-panel-title" style={{ fontSize: '11px', marginBottom: '6px' }}>สาขา 1: {formData.branch1}</div>
                      <div className="rating-group">
                ...
                {/* Q8 */}
                <div className="question-row">
                  <div className="question-text">8. พี่เลี้ยง/ผู้สอน มีความรู้ ความเชี่ยวชาญ สามารถอธิบาย/ถ่ายทอดเนื้อหาได้อย่างเข้าใจ</div>
                  <div className="branch-comp-grid">
                    <div>
                      <div className="branch-panel-title" style={{ fontSize: '11px', marginBottom: '6px' }}>สาขา 1: {formData.branch1}</div>
                      <div className="rating-group">
                ...
                {/* Q9 */}
                <div className="question-row">
                  <div className="question-text">9. พี่เลี้ยง/ผู้สอนได้อธิบายและให้ความสำคัญเรื่องความปลอดภัยหน้างานและมาตรฐานสุขอนามัย (Food Safety)</div>
                  <div className="branch-comp-grid">
                    <div>
                      <div className="branch-panel-title" style={{ fontSize: '11px', marginBottom: '6px' }}>สาขา 1: {formData.branch1}</div>
                      <div className="rating-group">
                ...
                {/* Q10 */}
                <div className="question-row">
                  <div className="question-text">10. พี่เลี้ยง/ผู้สอน มีความใส่ใจ เป็นมิตร และเปิดโอกาสให้สอบถามข้อสงสัย</div>
                  <div className="branch-comp-grid">
                    <div>
                      <div className="branch-panel-title" style={{ fontSize: '11px', marginBottom: '6px' }}>สาขา 1: {formData.branch1}</div>
                      <div className="rating-group">
                ...
                {/* Q11 */}
                <div className="question-row">
                  <div className="question-text">11. ภาพรวมทีมงานและบรรยากาศในสาขา ให้การต้อนรับและสนับสนุนการเรียนรู้ของท่าน</div>
                  <div className="branch-comp-grid">
                    <div>
                      <div className="branch-panel-title" style={{ fontSize: '11px', marginBottom: '6px' }}>สาขา 1: {formData.branch1}</div>
                      <div className="rating-group">
            ...
            {step === 4 && (
              <div className="step-content">
                <div className="section-header">
                  ...
                  <div className="section-desc">ช่วยให้ข้อมูลเพิ่มเติมเพื่อประกอบการพัฒนาระบบฝึกอบรม (ระบุได้ตามความสมัครใจ)</div>
                </div>

                {/* Q12 */}
                <div className="form-group">
                  <label className="form-label" htmlFor="feedback12">
                    12. งานในส่วนใดหรือเนื้อหาใด ที่ท่านคิดว่า "เข้าใจยาก/ท้าทายที่สุด" เพราะเหตุใด
                  </label>
                  <textarea
                    id="feedback12"
                    className="form-input"
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, feedback12_challenging: e.target.value }))}
                ...
                <div className="form-group">
                  <label className="form-label" htmlFor="feedback13">
                    13. ท่านคิดว่าจำนวนวันและจำนวนสาขาที่เหมาะสมในการฝึกหน้าร้านนี้ควรเป็นอย่างไร
                  </label>
                  <textarea
                    id="feedback13"
                    className="form-input"
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, feedback13_ideal_setup: e.target.value }))}
                    placeholder="ข้อคิดเห็นของท่าน..."
                  />
                </div>
                ...
                <div className="form-group">
                  <label className="form-label" htmlFor="feedback14">
                    14. สิ่งที่ประทับใจในการฝึกหน้าร้าน
                  </label>
                  <textarea
                    id="feedback14"
                    className="form-input"
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, feedback14_impressions: e.target.value }))}
                    placeholder="ข้อคิดเห็นของท่าน..."
                  />
                </div>
                ...
                <div className="form-group">
                  <label className="form-label" htmlFor="feedback15">
                    15. ข้อเสนอแนะอื่นๆ เพื่อการพัฒนาโปรแกรมการฝึกหน้าร้านต่อไป
                  </label>
                  <textarea
                    id="feedback15"
                    className="form-input"
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, feedback15_suggestions: e.target.value }))}
                    placeholder="ข้อคิดเห็นของท่าน..."
                  />
                </div>
